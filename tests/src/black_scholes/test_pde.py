...
class TestTerminalConditionCall:
    ...
    def test_matches_call_price_as_time_to_expiry_shrinks(self):
...
class TestTerminalConditionPut:
    ...
    def test_matches_put_price_as_time_to_expiry_shrinks(self):
...
class TestCallBoundaryConditionLower:
    ...
    def test_matches_call_price_at_tiny_stock_price(self):
...
class TestCallBoundaryConditionUpper:
    def test_matches_call_price_at_huge_stock_price(self):
    ...
    def test_reduces_to_forward_value_with_no_dividend(self):
...
class TestPutBoundaryConditionLower:
    def test_equals_discounted_strike(self):
        result = put_boundary_condition_lower(100, 0.05, 1)
        expected = 100 * np.exp(-0.05 * 1)
        assert result == pytest.approx(expected, rel=1e-10)

    def test_matches_put_price_at_tiny_stock_price(self):
...
class TestPutBoundaryConditionUpper:
    ...
    def test_matches_put_price_at_huge_stock_price(self):
...
class TestCrossConsistency:
    def test_call_satisfies_pde_and_correct_boundaries_simultaneously(self):
    ...
    def test_put_satisfies_pde_and_correct_boundaries_simultaneously(self):
        S, K, r, sigma, T, q = 100, 100, 0.05, 0.20, 1.0, 0.0
